  ...
  async function loadAll() {
    ...
    try {
      ...
      if(prefs.length > 0){
        ...
        newsUrl =
          `https://gnews.io/api/v4/search?q=${query}&lang=en&apikey=9e2d2cbee56f53cbfd7cf441a703b5fa`;
      ...
      <div className="grid grid-cols-4 gap-6">

        {
          Array.from({
            ...
            <div
              key={i}
              className="bg-zinc-900 rounded p-4 animate-pulse"
            >

              <div className="h-40 bg-zinc-800 rounded"/>

              <div className="h-4 bg-zinc-800 mt-3 rounded"/>
            ...
            >
              ...
              <div className="p-3">
                ...
                <button
                  ...
                  className="bg-white text-black w-full mt-3 p-2 rounded"
                >
                  Add Fav
                </button>
        ...
        movies.slice(0,8).map((m,i)=>(
          ...
          >
            ...
            <button
              ...
              className="bg-white text-black w-full mt-3 p-2"
            >
              Add Fav
            </button>
